...
import { Star, Users, Gamepad2, Smartphone } from "lucide-react";
...
export function MobileAppSection() {
  return (
    <section className="py-24 bg-gradient-to-b from-background to-background overflow-hidden relative border-t border-border/50">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            {/* Özellikler - Yenilenmiş Hover Efektleri */}
            <div className="space-y-4 mb-10 max-w-lg">
              {features.map((feature, index) => (
                <div
                  key={index}
                  className="group flex items-center gap-5 p-4 bg-card/40 backdrop-blur-sm rounded-2xl border border-border/50 hover:border-primary/40 hover:bg-primary/5 transition-all duration-500 shadow-sm hover:shadow-[0_0_20px_rgba(212,175,55,0.1)] hover:-translate-y-1"
                >
                  <div className="w-14 h-14 bg-background border border-border rounded-xl flex items-center justify-center shrink-0 group-hover:bg-primary group-hover:border-primary transition-all duration-500 shadow-sm group-hover:shadow-[0_0_15px_rgba(212,175,55,0.4)]">
                    <feature.icon className="w-6 h-6 text-muted-foreground group-hover:text-[#1A1A2E] transition-colors duration-500" />
                  </div>
                  <div>
           ...
           {/* İndirme Butonları - Profesyonel Yenileme */}
            <div className="flex flex-wrap gap-4 mb-12">
              
              {/* App Store Butonu */}
              <button className="flex items-center gap-3 bg-[#000000] text-white border border-white/10 px-7 py-3 rounded-xl transition-all duration-300 hover:bg-primary hover:text-[#1A1A2E] hover:border-primary hover:shadow-[0_0_30px_rgba(212,175,55,0.4)] hover:-translate-y-1 active:scale-95 group">
                <svg viewBox="0 0 384 512" fill="currentColor" className="w-6 h-6 mb-1 transition-colors">
                ...
                <div className="flex flex-col items-start text-left">
                  <span className="text-[9px] uppercase font-bold tracking-tighter opacity-70 group-hover:opacity-100">Download on the</span>
              ...
              {/* Google Play Butonu */}
              <button className="flex items-center gap-3 bg-[#000000] text-white border border-white/10 px-7 py-3 rounded-xl transition-all duration-300 hover:bg-primary hover:text-[#1A1A2E] hover:border-primary hover:shadow-[0_0_30px_rgba(212,175,55,0.4)] hover:-translate-y-1 active:scale-95 group">
                <svg viewBox="0 0 512 512" fill="currentColor" className="w-6 h-6 transition-colors">
                  <path d="M325.3 234.3L104.6 13l280.8 161.2-60.1 60.1zM47 0C34 6.8 25.3 19.2 25.3 35.3v441.3c0 16.1 8.7 28.5 21.7 35.3l256.6-256L47 0zm425.2 225.6l-58.9-34.1-65.7 64.5 65.7 64.5 60.1-34.1c18-14.3 18-46.5-1.2-60.8zM104.6 499l280.8-161.2-60.1-60.1L104.6 499z" />
                </svg>
                <div className="flex flex-col items-start text-left">
                  <span className="text-[9px] uppercase font-bold tracking-tighter opacity-70 group-hover:opacity-100">GET IT ON</span>
          ...
          {/* Sağ Taraf: Mobil Cihaz Mock-up'ları - Geliştirilmiş Glow Efektleri */}
          <div className="order-1 lg:order-2 relative h-[450px] md:h-[600px] flex justify-center w-full mt-10 lg:mt-0">
            
            {/* Sol Telefon */}
            <div className="hidden md:block absolute left-0 lg:-left-8 top-12 z-10 transform -rotate-12 transition-all duration-700 hover:scale-105 hover:-rotate-6 hover:z-30 opacity-60 hover:opacity-100">
              <div className="relative">
                ...
                <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 whitespace-nowrap">
                  <span className="text-xs font-bold text-muted-foreground bg-card px-4 py-1.5 rounded-full border border-border">
                    {phones[0].label}
                  </span>
                </div>
              </div>
            ...
            <div className="absolute top-0 z-20 transform transition-all duration-700 hover:scale-[1.03] hover:-translate-y-4">
              <div className="relative group">
                {/* Telefonun arkasındaki Altın Işıltı */}
                <div className="absolute -inset-4 bg-primary/20 rounded-[3.5rem] blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
                
                <div className="w-56 md:w-64 h-[450px] md:h-[500px] bg-[#0A0A0A] rounded-[3rem] p-2.5 shadow-[0_0_50px_rgba(0,0,0,0.5)] border border-primary/30 relative z-10 transition-colors group-hover:border-primary">
                  <div className="relative w-full h-full rounded-[2.5rem] overflow-hidden bg-background">
                    <Image src={phones[1].src} alt={phones[1].alt} fill className="object-cover group-hover:scale-110 transition-transform duration-1000" priority />
                  </div>
                </div>
                <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 whitespace-nowrap z-30">
                  <span className="text-sm font-black text-[#1A1A2E] bg-primary px-8 py-2.5 rounded-full border border-primary/50 shadow-[0_10px_30px_rgba(212,175,55,0.4)]">
                    {phones[1].label}
                  </span>
                </div>
              </div>
            ...
            {/* Sağ Telefon */}
            <div className="hidden md:block absolute right-0 lg:-right-8 top-12 z-10 transform rotate-12 transition-all duration-700 hover:scale-105 hover:rotate-6 hover:z-30 opacity-60 hover:opacity-100">
              <div className="relative">
                <div className="w-48 h-[400px] bg-card/80 backdrop-blur-md rounded-[2.5rem] p-1.5 shadow-2xl border border-border/50">
                  <div className="relative w-full h-full rounded-[2rem] overflow-hidden bg-background">
